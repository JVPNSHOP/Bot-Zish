...
# Enhanced installer for ZIVPN + Telegram bot (v6.9) with Button-Based Admin Commands
...
echo "== ZIVPN + Public Telegram Bot Installer (v6.9 - Button Interface) =="
...
# ============================================================================
# Bot script (v6.9) - COMPLETELY FIXED with Button-Based Interface
# ============================================================================
sudo tee /opt/zivpn_bot/bot.py > /dev/null <<'PY'
#!/usr/bin/env python3
# bot.py - Public ZIVPN bot (fixed v6.9) with BUTTON-BASED Interface
# COMPLETELY FIXED VERSION - Button interface for all commands
...
logger.info("Started zivpn public bot (fixed v6.9 with Button Interface) admin_notify=%s", ADMIN_IDS)
if not BOT_TOKEN:
...
async def handle_restore_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Handle restore confirmation callback"""
    query = update.callback_query
    await query.answer()
...
def main():
    ...
    logger.info("Public bot polling started (fixed v6.9 with Button Interface)")
    app.run_polling()
...
echo ""
echo "== INSTALL COMPLETE v6.9 with BUTTON-BASED INTERFACE =="
echo ""
...
echo ""
echo "✅ Installation complete with BUTTON-BASED INTERFACE!"
