...
# Fixed: Conversation flow works properly now
set -euo pipefail
IFS=$'\n\t'
...
# Bot script (public, fixed to accept numeric expiry input)
...
echo "Bot is running. To test: delete bot chat (clear history), then open bot and send /start -> Create Account -> follow the flow."
echo "Now typing numeric days in expiry step (e.g., 30 or 60) will be accepted."
