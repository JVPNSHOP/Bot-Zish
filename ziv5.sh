...
# sysctl tweaks & enable ip forwarding
...
# Remove any DNAT for our range (best-effort)
...
# Add correct DNAT and POSTROUTING MASQUERADE
...
async def edit_exp_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await q.edit_message.reply_text = None  # silence potential linter warnings
